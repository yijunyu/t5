...
unsafe fn main_0() -> libc::c_int {
    ...
    let mut degrees: [libc::c_double; 33] = [
        0.0f64,
        16.87f64,
        16.88f64,
        33.75f64,
