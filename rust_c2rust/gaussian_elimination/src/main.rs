...
pub unsafe extern "C" fn swap_row(
    ...
    let mut p2: *mut libc::c_double = 0 as *mut libc::c_double;
...
pub unsafe extern "C" fn gauss_eliminate(
    ...
    let mut max_row: libc::c_int = 0;
    let mut dia: libc::c_int = 0;
    ...
    while dia < n {
        ...
        while row < n {
            ...
            *a.offset((row * n + dia) as isize) = 0 as libc::c_int as libc::c_double;
...
unsafe fn main_0() -> libc::c_int {
    ...
    let mut x: [libc::c_double; 6] = [0.; 6];
    let mut i: libc::c_int = 0;
    gauss_eliminate(a.as_mut_ptr(), b.as_mut_ptr(), x.as_mut_ptr(), 6 as libc::c_int);
    i = 0 as libc::c_int;
    while i < 6 as libc::c_int {
        printf(b"%g\n\0" as *const u8 as *const libc::c_char, x[i as usize]);
        i += 1;
        i;
    }
